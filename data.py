...
class DICEFactorizationDataset(FactorizationDataset):
    ...
    def make_sampler(self, flags_obj, dm):
        ...
        train_coo_record = dm.coo_record #37962x4819 user x item
        train_lil_record = transformer.coo2lil(train_coo_record) #lil: list of list
        train_dok_record = transformer.coo2dok(train_coo_record) #dof: dictionary of keys
