...
sys.path.append('/Users/djd/Desktop/code/DICE-main')
...
flags.DEFINE_string('output', '/Users/djd/Desktop/code/DICE-main/output/', 'Directory to save model/log/metrics.')
